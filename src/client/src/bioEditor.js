...
function BioEditor(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "bio-container" }, { children: [bio && !showTextArea && ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "bio-display" }, { children: [bio &&
                        ...
                        }), (0, jsx_runtime_1.jsx)("button", __assign({ onClick: toggleBioEditor }, { children: "Edit Bio" }))] }))), !bio && !showTextArea && ((0, jsx_runtime_1.jsx)("button", __assign({ onClick: toggleBioEditor }, { children: "Add Bio" }))), showTextArea && ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "bio-display" }, { children: [(0, jsx_runtime_1.jsx)("textarea", { value: draftBio, onChange: handleBioChange, rows: 5, cols: 20 }), (0, jsx_runtime_1.jsx)("button", __assign({ onClick: submitBio }, { children: "Save" }))] })))] })));
}
