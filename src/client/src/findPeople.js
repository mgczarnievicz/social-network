...
function FindPeople() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "search-container" }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "search-inputs" }, { children: [(0, jsx_runtime_1.jsx)("h1", { children: "Friends" }), (0, jsx_runtime_1.jsx)("input", { onChange: function (e) { return setSearch(e.target.value); }, value: searchInput })] })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "friend-container" }, { children: friends &&
                    friends.map(function (friend, i) {
                        console.log("Friend", friend);
                        return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "friend-info" }, { children: [(0, jsx_runtime_1.jsx)("img", { src: friend.photourl }), (0, jsx_runtime_1.jsxs)("h3", { children: [friend.name, friend.surname] })] }), friend.id));
                    }) }))] })));
}
