...
var ResetPassword = /** @class */ (function (_super) {
    ...
    ResetPassword.prototype.determineViewToRender = function () {
        ...
        switch (this.state.view) {
            case 1:
                return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "form" }, { children: [(0, jsx_runtime_1.jsx)("h2", { children: "Step 1:" }), (0, jsx_runtime_1.jsx)("p", { children: "Enter your mail" }), (0, jsx_runtime_1.jsx)("input", { type: "email", name: "email", placeholder: "Email", required: true, ref: "emailRef", onChange: this.handleChange }, "email"), (0, jsx_runtime_1.jsx)("button", __assign({ onClick: this.handleSendEmail }, { children: "Submit" }))] })));
            case 2:
                return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "form" }, { children: [(0, jsx_runtime_1.jsx)("h2", { children: "Step 2:" }), (0, jsx_runtime_1.jsx)("p", { children: "Verify your email where you recived your code and enter a new password" }), (0, jsx_runtime_1.jsx)("input", { type: "text", name: "code", placeholder: "code", required: true, ref: "codeRef", onChange: this.handleChange }, "code"), (0, jsx_runtime_1.jsx)("input", { type: "password", name: "newPassword", placeholder: "Password", required: true, ref: "passwordRef", onChange: this.handleChange }, "password"), (0, jsx_runtime_1.jsx)("button", __assign({ onClick: this.handleSetNewPassword }, { children: "Submit" }))] })));
            case 3:
