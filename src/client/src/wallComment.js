...
function WallComments(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(comments_1.default, { postId: props.postId }, props.postId), (0, jsx_runtime_1.jsx)(commentWrite_1.default, { postId: props.postId })] }));
}
